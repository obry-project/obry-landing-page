...
export default function Home() {
  ...
  return (
    <main>
      <Header />
      <Hero />
      {/* className="max-w-[1200px] mx-auto px-6 py-20 reveal" */}
      <section className="max-w-[1200px] mx-auto py-16 px-6 bg-[radial-gradient(circle_at_top,#f8fafc,var(--dark))] reveal">
