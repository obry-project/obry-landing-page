...
export default function FinalCTA() {
  const primaryLink = FEATURES.SHOW_WAITLIST_FORM ? FEATURES.WAITLIST_FORM_URL : 'https://wa.me/595972117101?text=Hola%2C%20quiero%20solicitar%20una%20demo%20de%20Obry'
  const secondaryLink = "https://wa.me/595972117101?text=Hola%2C%20quiero%20información%20sobre%20Obry"
  ...
  return (
    <section id="demo" className="max-w-[1200px] mx-auto px-6 py-24 text-center bg-gradient-to-br from-[var(--gold)]/5 to-white border border-[var(--gold)]/20 rounded-3xl my-24 reveal relative overflow-hidden">
      ...
      <div className="flex justify-center gap-6 flex-wrap relative z-10">
        ...
        >
          {FEATURES.SHOW_WAITLIST_FORM ? 'Sumarme a la Lista de Espera' : 'Solicitar Demo Gratis'}
        </a>
        <a 
          href={secondaryLink}
          target="_blank"
